...
# check for outliers
# Identify and understand the presence of any outliers and determine whether to remove them or not.
# Check for data distribution: Understand the distribution of each variable in the dataset. 
# Identify whether the data is normally distributed or skewed, and determine whether transformations are necessary.
...
## Descriptive Statistics: To understand the central tendency, variability, and spread of the data.
```{r}
