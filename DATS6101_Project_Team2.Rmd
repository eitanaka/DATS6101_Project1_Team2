...
##We have created two scatter plots to explore the relationships between two health risk behaviors (lack of sleep and lack of physical activity) and two health outcomes (Depression and MHLTH) and health status.In the first scatter plot, you've plotted the percentage of people who report lacking sleep on the x-axis, and the percentage of people who report Depression and MHLTH on the y-axis.You've colored the points by health outcome (red for Depression and green for MHLTH) to help differentiate the two. Additionally, you've added linear regression lines to each scatter plot using geom_smooth(). This can help show the general trend in the data and highlight any relationships that might exist.In the second scatter plot, you've plotted the percentage of people who report lacking physical activity on the x-axis, and the percentage of people who report Depression and MHLTH on the y-axis. You've again colored the points by health outcome (red for Depression and green for MHLTH), and added linear regression lines to each scatter plot using geom_smooth().The correlations between various variables in your data can be better understood with these scatter plots.You can introduce the variables being plotted and describe what the x and y axes stand for when presenting them.The scatter plots can then be displayed, with any patterns or connections being highlighted. In light of your data and research topic, you might additionally talk about the consequences of these associations.**
...
## 6. References
**Centers for Disease Control and Prevention. (2021, October 18). Measure definitions. Centers for Disease Control and Prevention. Retrieved March 8, 2023, from https://www.cdc.gov/places/measure-definitions/index.html Centers for Disease Control and Prevention. (n.d.). Places: Local data for better health, Census Tract Data 2022 release. Centers for Disease Control and Prevention. Retrieved March 8, 2023, from** **https://chronicdata.cdc.gov/500-Cities-Places/PLACES-Local-Data-for-Better-Health-Census-Tract-D/cwsq-ngmh **
