...
ggplot(mean_df_long, aes(x = "", y = Value, fill = Variable)) +
  ...
  scale_fill_manual(values = c("pink","lightgreen", rgb(200, 162, 200, maxColorValue = 255), "cyan")) +
  scale_color_manual(values = c("darkred","darkgreen", "darkorchid", "darkblue")) +
  labs(title = "Box plots of population proportions for each Measure", x="Health conditions", y = "Population proportion") +
