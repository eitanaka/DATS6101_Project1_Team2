...
Linear_reg <- lm(Depression ~ Sleep, data = mean_df)
summary(Linear_reg)

Linear_reg <- lm(Depression ~ LPA, data = mean_df)
summary(Linear_reg)

Linear_reg <- lm(MHLTH ~ Sleep, data = mean_df)
summary(Linear_reg)

Linear_reg <- lm(MHLTH ~ LPA, data = mean_df)
summary(Linear_reg)
```
