...
mean_df["fips"] <- fips(mean_df$State)

plot_usmap(data=mean_df, values="Mean_Depression", labels = TRUE) +
...
plot_usmap(data=mean_df, values="Mean_LPA", labels = TRUE) +
  scale_fill_continuous(low = "white", high = "red", guide = FALSE) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
  ggtitle("Mean_LPA by State") +
  guides(fill = guide_colorbar(title = "Mean_LPA", 
                                title.position = "top", 
                                title.hjust = 0.5, 
                                label.position = "left",
                                label.hjust = 0.5))
...
# Create a new maps object
plot_usmap(data=mean_df, values="Mean_Sleep", labels = TRUE) +
  scale_fill_continuous(low = "white", high = "red", guide = FALSE) +
  scale_x_continuous(expand = c(0, 0)) + scale_y_continuous(expand = c(0, 0)) +
